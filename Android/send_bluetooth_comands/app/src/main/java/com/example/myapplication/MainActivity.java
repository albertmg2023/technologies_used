...
public class MainActivity extends AppCompatActivity {
    ...
    public void forward() {
        try {
            ...
            String tmpStr2 = "1\n";
            byte bytes2[] = tmpStr2.getBytes();
            if (outputStream != null) outputStream.write(bytes2);
            if (outputStream != null) outputStream.flush();
        } catch (Exception e) {
    ...
    protected void connect(BluetoothDevice device) {
        new Thread(() -> {
            try {
                // Detener la búsqueda de dispositivos antes de conectar
                ...
                // Puedes iniciar la lectura aquí si deseas


            } catch (Exception e) {
                Log.e("ERROR: connect", "Connection failed", e);
            }
        }).start();
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(remoteDeviceName != null) {
                if (remoteDeviceName.equals("ROBOTIS_210_70")) {
                    Log.d("onReceive", "Discovered HUAWEI P30 lite:connecting");
    ...
    public void disconnect() {
        try {
            if (btSocket != null) {
                ...
                outputStream = null;
                inputStream = null;
                Log.d("MyFirstApp", "Disconnected");
            }
        } catch (Exception e) {
            Log.e("ERROR: disconnect", ">>", e);
        }
    }
